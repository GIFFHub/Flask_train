...
class UserInfoForm(Form):
    name = StringField('名前：', validators=[DataRequired('名前は必須入力です')], render_kw={"placeholder":"(例)山田太郎"})
    age = IntegerField('年齢：', validators=[NumberRange(18, 100, '入力範囲は18才から100才です')],  default=20)
